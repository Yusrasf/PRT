...
Developed as part of the *Applied Project Management (APM)* course at *FH Technikum Wien*, this prototype integrates both **frontend (Vue.js)** and **backend (FastAPI + Java)** components that communicate with a **public HAPI FHIR server**.
...
5. Wilford et al., *“The Digital Network of Networks: Regulatory Risk and Policy Challenges of Vaccine Passports,”* Eur. J. Risk Regulation (2021).
